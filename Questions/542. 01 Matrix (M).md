...
```
---
- 其實不難，Multi-source BFS，將所有 0 都加入初始節點，並在 traverse 時加入距離，重複就不用再走
- 但應該還是 DP 的做法比較快，先看該格的左上再看右下，原理看 [說明](https://leetcode.com/problems/01-matrix/description/comments/1564921/)